...
processScriptFromFile('./cs142-format-time.js');
processScriptFromFile('./cs142-filter.js');
...
var p4Message = global.cs142Project2Results.p4Message;


var testWorked =  (p1Message === 'SUCCESS') &&  (p2Message === 'SUCCESS') &&
    (p3Message === 'SUCCESS') &&  (p4Message === 'SUCCESS');
